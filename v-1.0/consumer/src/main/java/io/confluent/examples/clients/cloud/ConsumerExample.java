...
public class ConsumerExample {
  ...
  public static void main(final String[] args) throws Exception {
    ...
    // final Serde<String> stringSerde = Serdes.String();
    // final Serde<Double> doubleSerde = Serdes.Double();
    // props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, stringSerde.deserializer());
    // props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, doubleSerde.deserializer());
    ...
    try {
      while (true) {
        ...
        for (ConsumerRecord<String, Double> record : records) {
          ...
          //total_count += value;
          //System.out.printf("Consumed record with key %s and value %f, and updated total count to %f%n", key, value, total_count);
